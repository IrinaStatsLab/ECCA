...
fig.path = "Simulation/GB_Simulation_SNR5/Figures/"
pdf(file = paste(fig.path,"Whole_Estimation_Error_GB_SNR5_Draft.pdf",sep=""), width = 16, height = 9)
print(gg)
dev.off()

fig.path = "Simulation/GB_Simulation_SNR5/Figures/"
pdf(file = paste(fig.path,"Whole_Joint_Error_GB_SNR5_subspace_Draft.pdf",sep=""), width = 16, height = 9)
print(gg_joint)
dev.off()