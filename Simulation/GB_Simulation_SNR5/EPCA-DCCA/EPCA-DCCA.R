...
save(res_DCCA_list, res_EPCA_DCCA_list, res_DCCA_list_rank1, res_EPCA_DCCA_list_rank1, 
     res_DCCA_mu1_list, res_DCCA_mu2_list, res_EPCA_DCCA_mu1_list, res_EPCA_DCCA_mu2_list, file = "Simulation/GB_Simulation_SNR5/DCCA_result.RData")