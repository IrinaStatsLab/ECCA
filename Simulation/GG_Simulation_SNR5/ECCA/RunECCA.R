...
for (i in 1:nrep){
  X1 = X1_true[[i]]
  X2 = X2_true[[i]]
  temp_res = ecca_v2(X1, X2, r0, r1, r2, family1 = family1, family2 = family2, gamma = 1000)
...
save(theta1_est, theta2_est, U1_est, U2_est, Z1_est, Z2_est, mu1_est, mu2_est, 
     V1_est, V2_est, A1_est, A2_est, loss, constraints, file = "Simulation/GG_Simulation_SNR5/ECCA_result.RData")
