...
for (i in 1:nrep){
  sampledata = dataGenerator(r0, r1, r2, n = n, p = p, lambda = lambdas, family1, family2, SNR = SNR, size = trials)
...
save(X1_true, X2_true, theta1_true, theta2_true, U1_true, U2_true, Z1_true, Z2_true, 
     mu1_true, mu2_true, V1_true, V2_true, A1_true, A2_true, file = "Simulation/BB_Simulation_Trials100/Data.RData")